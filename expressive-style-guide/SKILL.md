...
|----|------|--------|-------------------|----------|
| **E.S1** | 圆角 | `rounded-lg` (8px) / `rounded-xl` (12px) | 可降至 `rounded-md` (6px) | 当 Minimal 为项目主风格，Expressive 仅用于辅助区域时 |
...
| **E.S4** | 暗色背景明度 | `hsl(0 0% 2%)` / `oklch(0.08 0 0)` 近纯黑 | 可提亮至 `oklch(0.145 0 0)` ≈ #1A1A1A | 当需要与 Minimal/Swiss 区域统一暗色模式基准时 |
